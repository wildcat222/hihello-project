...
<template>
  <div id="app">
    ...
    <div :class="['additional-buttons', { show: showAdditionalButtons }]">
      ...
      <button class="additional-button" @click="toggleChatModal"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
